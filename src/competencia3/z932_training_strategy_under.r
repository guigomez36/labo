...
PARAM  <- list()
PARAM$experimento <- "DS0001" 

PARAM$exp_input  <- "FE9250" # 

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202007, 202008, 202009, 202010, 202011, 202012,202101, 202102, 202103, 202104, 202105 )

PARAM$train$training     <- c( 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202007, 202008, 202009, 202010, 202011, 202012,202101, 202102, 202103, 202104, 202105 )
...
PARAM$train$semilla_under     <- 100103
